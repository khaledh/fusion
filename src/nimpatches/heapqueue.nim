...
## -------------------------
## To use a `HeapQueue` with a custom object, you must either:
## (1) implement the `<` operator for the object, or
## (2) provide a custom comparison function to the `initHeapQueue` procedure.
## 
## Example of (1):
## 
##   type Job = object
##     priority: int
## 
##   proc `<`(a, b: Job): bool {.inline.} = a.priority > b.priority
## 
##   var jobs = initHeapQueue[Job]()
## 
## Example of (2):
## 
##   proc cmpJobs(a, b: Job): bool {.inline.} = a.priority > b.priority
## 
##   var jobs = initHeapQueue[Job](cmpJobs)
...
type
  ...
  HeapCmp*[T] = proc (x, y: T): bool {.inline.}
...
proc initHeapQueue*[T](cmp: HeapCmp[T] = nil): HeapQueue[T] =
  ...
  ## this function explicitly, unless you want to provide a custom
  ## comparison function.
  ##
  ## **See also:**
